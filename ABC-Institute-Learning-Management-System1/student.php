...
<div class="container">
    <div class="row">
        ...
        <div class="column col-md-6">
           <a href="studentview.php?subject=<?php echo "physics" ?>" target="_blank">
          <img src="img/phy.png" alt="Nature" style="width:70%">
          <div class="caption">
            <p>*Enroll to Subject</p>
        ...
        <div class="column col-md-6">
                  <a href="studentview.php?subject=<?php echo "chemistry" ?>" target="_blank">
          <img src="img/chem.png" alt="Nature" style="width:70%">
          <div class="caption">
            <p>*Enroll to Subject</p>
         ...
         <div class="column col-md-6">
          <a href="studentview.php?subject=<?php echo "bio" ?>" target="_blank">
          <img src="img/bio.png" alt="Nature" style="width:70%">
          <div class="caption">
            <p>*Enroll to Subject</p>
          ...
          <div class="column col-md-6">
                  <a href="studentview.php?subject=<?php echo "maths" ?>" target="_blank">
          <img src="img/maths.png" alt="Nature" style="width: 70%">
          <div class="caption">
            <p>*Enroll to Subject</p>
...
<!-- 
      ...
      <div class="thumbnail">
        ...
        <a href="studentview.php?subject=<?php echo "physics" ?>" target="_blank">
          <img src="img/phy.png" alt="Nature" style="width:100%">
          <div class="caption">
            <p>*Enroll to Subject</p>
...
<div class="col-md-2">
      <div class="thumbnail">
        <a href="studentview.php?subject=<?php echo "chemistry" ?>" target="_blank">
          <img src="img/chem.png" alt="Nature" style="width:100%">
          <div class="caption">
            <p>*Enroll to Subject</p>
      ...
      <div class="thumbnail">
        <a href="studentview.php?subject=<?php echo "bio" ?>" target="_blank">
          <img src="img/bio.png" alt="Nature" style="width:100%">
          <div class="caption">
            <p>*Enroll to Subject</p>
      ...
      <div class="thumbnail">
        <a href="studentview.php?subject=<?php echo "maths" ?>" target="_blank">
          <img src="img/maths.png" alt="Nature" style="width:100%">
          <div class="caption">
            <p>*Enroll to Subject</p>
