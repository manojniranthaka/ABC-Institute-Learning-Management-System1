...
<div class="row">
    <div class="col-md-2">
      <div class="thumbnail">
        <a href="/w3images/lights.jpg" target="_blank">
          <img src="img/maths.png" alt="Lights" style="width:100%">
          <div class="caption">
            <form action="enroll.php"method="POST" >
            
             

              <input type="Password" id="password" name="Password" placeholder="Enter Key" required="required" autocomplete="off" /> 

              <input type="submit" name="Enroll"><p>*Enroll to Subject</p><br>
          </form>  
          </div>
        </a>
      </div>
    ...
    <br><div class="col-md-2">
      ...
      <div class="thumbnail">
        ...
        <div class="col-md-2">
      <div class="thumbnail">
        <a href="/w3images/bio.jpg" target="_blank">
