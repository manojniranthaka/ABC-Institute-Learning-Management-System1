...
<body>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js"></script>
      ...
      <div class="loginbox">
          ...
          <h1 style="margin: 0;padding: 0 0 20px;text-align: center;font-size: 22px;">Admin Login </h1>
  <?php
    if (@$_GET['Empty']==true) 
    {
  ...
  ?>
          ...
          <form action="adminprocess.php"method="POST" >
              ...
              <p>User name</p>
              <input type="text" id="user" name="name" placeholder="Enter Username"	required="required" autocomplete="off"/>
  
              <p>Password</p>
              <input type="Password" id="Apassword" name="pass" placeholder="Enter Password" required="required" autocomplete="off" /> 

              <input type="submit" id="btn" name="ALogin" value="Login"><br> <a href="#"><font style="color: #1588ff">Reset Your Password</font></a><br>
