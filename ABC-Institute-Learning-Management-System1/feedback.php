...
<body>
 ...
 <h1 style="font-family: fantasy; font-size: 40px; color: darkblue; margin-top: 40px; margin-left: 30px">FeedBack of Our Service</h1> 
 <br>
<p style="margin-left: 250px; font-size: 18px;  margin-right:250px ; font-family: inherit;">Please send us details about the incident you would like to report. Our Feedback Center will analyze your feedback and take the appropriate measures in order that the reported situation will not occur at any other time in the future.
</p>
<br>

<form style="margin-left: 400px;  margin-right: 200px " action="add_feedback.php" method="post">

     <fieldset>
    <h6 style="font-family: cursive;">Incident Location</h6>
    where the incident happened<br>   
    <input style="width: 1100px;border-radius: 4px;height: 50px" type="text" name="location" value="" required="">
    <br>
     <br>
    <h6 style="font-family: cursive;">Incident Date </h6>
     pick the date incident happened<br> 
    <input style="width: 1100px;border-radius: 4px;height: 50px" type="Date" name="date" value="" required="">
    <br>
    <br>
    <h6 style="font-family: cursive;">Feedback Details </h6>
    describe the incident<br>
    <input style="width: 1100px;border-radius: 4px;height: 100px" type="text" name="details" value="" required="">
    <br>
     <br>
     <h6 style="font-family: cursive;">Desired Outcome </h6>
    a solution that you suggest<br>
    <input style="width: 1100px;border-radius: 4px;height: 100px"  type="text" name="outcome" value="" required="">
    <br>
    <br>
      ...
      <button style="margin-left: 1020px" type="submit" value="submit" name="submit" required="" class="btn btn-outline-primary">Submit</button>
  </fieldset>
</form>
