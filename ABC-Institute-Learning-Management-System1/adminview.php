...
<head>
    ...
    <title>ABC Institute-View</title>
    ...
    <style>
        body {
            ...
            background-image: url("img/adminview.png");
        }
...
$sql = "SELECT title,teacher,upload FROM course WHERE subject = (select subject from course where id = (select max(id) from course))";

$records = mysql_query($sql);

$sq = "SELECT subject FROM course WHERE id = (select max(id) from course)";


$records_sq = mysql_query($sq);

while($row = mysql_fetch_object($records_sq)){
