...
$sql01 = "SELECT regno,image FROM uploadfile";
...
<br><br> <br>
 <h1 style="font-family: fantasy; font-size: 40px; color: darkblue; margin-top: 40px;"> Uploaded Assignments </h1>
 
 <br>

 <table  style="font-family: monospace; border-style: none; font-size: 18px;" width="1000" cellpadding="7" cellspacing="7" align="center">
<tr>
<th style="font-size: 22px;font-family: initial;">Registration No</th> 
<th style="font-size: 22px;font-family: initial;">Assignment</th>
...
echo "<tr>";
echo "<td>".$course01['regno']."</td>";
echo "<td>".$course01['image']."</td>";

echo "<td>"; ?>
    <a style="color: white; border-style: hidden; border-radius: 20px;  border-width: 5; background-color: darkgreen; padding: 4px; padding-left: 10px;padding-right: 10px;  " href="<?php echo $course01['image']; ?>"> download</a>
<?php echo "</td>";
