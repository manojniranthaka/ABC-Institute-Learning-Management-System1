...
?>  
 ...
 <h1 style="font-family: fantasy; font-size: 40px; color: darkblue; margin-top: 40px; margin-left: 500px"> Feedback View </h1> 
 
 

 <table style="font-family: monospace;  border-style: none; font-size: 18px; margin-left: 900px; color: black;"  width="800" cellpadding="8" cellspacing="8" align="center" >
<tr>
<th style="font-size: 20px;font-family: initial;">Location</th> 
<th style="font-size: 20px;font-family: initial;">Date</th>
<th style="font-size: 20px;font-family: initial;">Outcome</th> 
<th style="font-size: 20px;font-family: initial;">Details</th>
...
echo "<tr>";
echo "<td>".$timetable['location']."</td>";
echo "<td>".$timetable['date']."</td>";
echo "<td>".$timetable['outcome']."</td>";
echo "<td>".$timetable['details']."</td>";


echo "<td>"; ?>

 <!--    <a  style="color: white; border-style: hidden; border-radius: px;  border-width: 5; background-color: darkgreen; padding: 4px; padding-left: 10px;padding-right: 10px;  " href="<?php echo $timetable['upload']; ?>"> Download</a>
<?php echo "</td>";
echo "<td>"; ?> -->
