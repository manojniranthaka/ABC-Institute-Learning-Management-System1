...
<!--   CODE EK DAPn -->
 ...
 <br>
  ...
  class = "table table-bordered"
  	...
  	<tr>
  		<td><input type="text" class="form-control" placeholder="file Name" name="fileName" required="">
  			
  		</td>
  	</tr>

  	<tr>
  		<td><input type="file" name="f1" required="">
  			
  		</td>
  	</tr>

  	<tr>
  		<td><input type="text" class="form-control" placeholder="Subject" name="Subject" required="">
  			
  		</td>
  	</tr>

  	<tr>
  		<td><input type="text" class="form-control" placeholder="Edition" name="Edition" required="">
  			
  		</td>
  	</tr>

  	<tr>
  		<td><input type="text" class="form-control" placeholder="Author" name="Author" required="">
  	...
  	<tr>
  		<td><input type="submit" name="submit1" class="button" value="Insert files Details" style="background-color: blue;color: white ">
...
$query = "insert into addfiles(fileName,Subject,Edition,Author,bookImage) values('$fileName','$Subject','$Edition','$Author','$bookImage')"; 
