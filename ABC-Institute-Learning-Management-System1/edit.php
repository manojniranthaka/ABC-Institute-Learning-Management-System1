...
mysql_query("UPDATE course SET  subject = '$subject' , title = '$title',teacher = '$teacher' ,  upload = '$location' WHERE id = '$id' ");
    
}
#header('location:viewall.php');

?>
<H1 style="">UPDATE LESSONS</H1>
<form   style="    padding-left: 24%;" method="get" enctype="multipart/form-data" action="">
...
<td>
    ...
    <td>
        <select name="subject" value = "<?php echo $row['subject']  ?>">
            
            <option value="physics">Physics</option>
            <option value="chemistry">Chemistry</option>
            <option value="bio">Biology</option>
            <option value="combined">Combined Maths</option>
        </select>
...
<td>
    <input type="text" name ="title" maxlength="50px" size="30" value = "<?php echo $row['title']  ?>">
</td>
</tr>
...
<td>
    <input type="text" name ="teacher" maxlength="50px" size="30" value = "<?php echo $row['teacher']  ?>">
</td>
</tr>
<tr>
...
<input type="File" name="upload" value="<?php echo $row['upload']  ?>" >
...
<tr>
    <td align="center">
        <button type="submit" value="update" name="submit" class="btn btn-outline-primary">Submit</button>
