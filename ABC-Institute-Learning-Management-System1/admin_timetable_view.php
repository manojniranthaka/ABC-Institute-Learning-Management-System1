...
?>  
 ...
 <h1 style="font-family: fantasy; font-size: 40px; color: darkblue; margin-top: 40px;"> Time Table </h1> 
 
 

 <table style="font-family: monospace; border-style: none; color: black; font-size: 18px;" width="1000" cellpadding="6" cellspacing="5" align="center">
<tr style="column-span: 5px;">
<th style="font-size: 22px;font-family: initial;">Year</th> 
<th style="font-size: 22px;font-family: initial;">Semester</th>
...
while ($timetable = mysql_fetch_assoc($records01)) {
echo "<tr>";
echo "<td>".$timetable['year']."</td>";
echo "<td>".$timetable['semester']."</td>";
 "<td>".$timetable['upload']."</td>";

echo "<td>"; ?>

    <a style="color: white; border-style: hidden; border-radius: 20px;  border-width: 5; background-color: darkgreen; padding: 6px; padding-left: 10px;padding-right: 10px;  "  href="<?php echo $timetable['upload']; ?>"> Download</a>
<?php echo "</td>";
echo "<td>"; ?>
    <a style="color: white; border-style: hidden; border-radius: 20px;  border-width: 5; background-color: darkblue; padding: 6px; padding-left: 10px; padding-right: 10px;  "  href="edittimetable.php?tid=<?php echo $timetable['tid']?>" >Edit</a>
<?php echo "</td>";
echo "<td>"; ?>
<a style="color: white; border-style: hidden; border-radius: 20px;  border-width: 5; background-color: darkred; padding: 6px; padding-left: 10px; padding-right: 10px;  "  href="deletetimetable.php?tid=<?php echo $timetable['tid']?>" >Delete</a>
<?php echo "</td>";
echo "<td>"; ?>
    <!-- <a href=" delete.php?id=<?php echo $timetable['id']?>" >Delete</a> -->
